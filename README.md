...
<div>
  ...
  <p style="margin: 0;">
    <b>フオンドン大学 システムエンジニア育成プログラム(日本語特化)3年生</b> | GPA: 3.75 | <br><span style="white-space: nowrap;">JLPT N3 🇯🇵</span><br>
  ...
  <ul style="margin-top: 0;">
    ...
    <li>🏆 <b>実績</b>:
      <ul>
        <li>GPA: 3.75 (成績優秀奨学金受賞) / 日本語能力試験 N3 合格</li>
        <li>大学のITコンテスト「Devrank」運営・企画 (2年連続)</li>
        <li>授業のPBL(グループ開発)でリーダーを担当</li>
      </ul>
    </li>
    <li>💼 <b>経験</b>:
      <ul>
        <li>株式会社CodeGym：フルスタック担当 インターンシップ</li>
        <li>株式会社Deha：バックエンド担当 インターンシップ (.NET / 約3ヶ月)</li>
      </ul>
    </li>
    <li>❤️ <b>趣味</b>: 読書（三国志などの歴史の本）や、日本の文化（アニメなど）が好きです。</li>
    <li>💬 <b>強み</b>: チーム開発での「報連相」と、ユーザー視点でのUI/UX最適化。</li>
    <div style=" margin-left: 220"><li>👯 将来はフルスタックエンジニアとして、日本のIT企業に貢献したいです！</li></div>
  </ul>
</div>
